...
# -*-coding:utf-8-*
"""
@File    :   demo04_gazebo_obstacle_world.py
@Time    :   2023/11/14 15:53:39
@Author  :   Arvin 
@Version :   1.0
...
class envmodel():
    def __init__(self):
        ...
        self.subimage = rospy.Subscriber('/camera/rgb/image_raw', Image, self.image_callback)
        # 接收agent robot的激光雷达信息
        self.subLaser = rospy.Subscriber('/scan', LaserScan, self.laser_states_callback)
        # 发布控制指令给agent robot
