...
# 环境模型：demo02_gazebo_empty_world.py
...
# 导入的网络模型：无
# 对应的reward文件：
# ../saved_rewards/empty_world_reward_v1.txt
# ../saved_rewards/empty_world_reward_v1.png
# 训练好的网络模型:
# ../saved_networks/empty_world_2023-11-07_v1
...
from demo02_gazebo_empty_world import envmodel
...
class DQN:
    def __init__(self):
        ...
        self.load_path = '../scripts/saved_networks/empty_world_2023-11-13_v3'
    ...
    def init_sess(self):
        ...
        # ------------------------------
        os.makedirs('saved_networks/' + 'empty_world_' + self.date_time)
        # ------------------------------
    ...
    def save_model(self):
        # ------------------------------
        save_path = self.saver.save(self.sess, 'saved_networks/' + 'empty_world_' + self.date_time + "/model.ckpt")
        # ------------------------------
    ...
    def main(self):
        ...
        while(True):
            ...
            if 20.0 < math.sqrt((randposition[0][0]-randposition[1][0])**2+(randposition[0][1]-randposition[1][1])**2) < 30.0:
                break
        ...
        while True:
            ...
            if terminal == True:
                ...
                if self.progress == 'Training':
                    ...
                    # ------------------------------
                    np.savetxt('saved_rewards/empty_world_reward.txt', reward_array, delimiter=',')                  
                    # ------------------------------
