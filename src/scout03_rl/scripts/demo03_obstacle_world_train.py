...
# -*-coding:utf-8-*
"""
@File    :   demo03_obstacle_world_train.py
@Time    :   2023/11/14 15:56:33
@Author  :   Arvin 
@Version :   1.0
...
# 环境模型：demo04_gazebo_obstacle_world.py
# launch文件：demo01_gazebo.launch
# world文件：obstacle_sensor.world

# 第一次训练
# 导入的网络模型：无
# 对应的reward文件：
# ../saved_rewards/obstacle_world_reward_v1.txt
# ../saved_rewards/obstacle_world_reward_v1.png
# 训练好的网络模型:
# ../saved_networks/obstacle_world_2023-11-14_v1

# 第二次训练
# 导入的网络模型：../saved_networks/obstacle_world_2023-11-14_v1
# 对应的reward文件：
# ../saved_rewards/obstacle_world_reward_v2.txt
# ../saved_rewards/obstacle_world_reward_v2.png
# 训练好的网络模型:
# ../saved_networks/obstacle_world_2023-11-14_v2
...
from demo04_gazebo_obstacle_world import envmodel
...
class DQN:
    ...
    def init_sess(self):
        ...
        # 第一次训练
        os.makedirs('saved_networks/' + 'obstacle_world_' + self.date_time)
    ...
    def save_model(self):
        # 第一次训练
        save_path = self.saver.save(self.sess, 'saved_networks/' + 'obstacle_world_' + self.date_time + "/model.ckpt")
        # 第二次训练
        ...
        while True:
            ...
            if terminal == True:
                ...
                if self.progress == 'Training':
                    ...
                    # 第一次训练
                    np.savetxt('saved_rewards/obstacle_world_reward.txt', reward_array, delimiter=',')
                    # 第二次训练
